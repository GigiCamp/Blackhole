...
import com.example.pa_pe.blackhole.chat.ChatAppActivity;
...
public class AdapterUsers extends RecyclerView.Adapter<AdapterUsers.MyHolder>{
    ...
    /**
     * Instantiates a new Adapter users.
     *
    ...
    @Override
    public void onBindViewHolder(@NonNull MyHolder holder, int i) { //Chiama questo metodo per vedere i dati in una data posizione
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                richiamoPagina(userName, userImage);
            }
        });
    }

    private void richiamoPagina(String nomeProfilo, int immagineProfilo){
